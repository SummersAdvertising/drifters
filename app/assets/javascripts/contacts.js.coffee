$ ->
  ...
  $(document).on 'ready', (evt) ->
    if $("#contact_looking_for_all") && $("#contact_looking_for_all").text() == "ALL"
      ...
      # all_tours = ['Kruger_Park_5_day', 'South_Africa_18_day', 'Namibia_12_day', 'Southern_Circle_24_day', 'Uganda_12_day', 'Southern_Cruise_24_day', 'Botswana_16_day', 'East_Africa_12_day', 'Mozambique_14_day', 'Zimbabwe_16_day']
